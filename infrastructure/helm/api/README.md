...
- **Service**: `csbc-nodejs-starter-postgres-pgbouncer` (connection pooler)
- **Secret**: `csbc-nodejs-starter-postgres-pguser-postgres` (contains database credentials)
- **Database**: `csbc-nodejs-starter-postgres`
- **User**: `postgres`
...
|-----------|-------------|---------|
| `app.database.name` | Database name | `csbc-nodejs-starter-postgres` |
| `app.database.host` | Database host (pgBouncer service) | `csbc-nodejs-starter-postgres-pgbouncer` |
| `app.database.user` | Database username | `postgres` |
| `app.database.secretName` | Secret containing password (from database chart) | `csbc-nodejs-starter-postgres-pguser-postgres` |
...
- The database chart creates a secret: `csbc-nodejs-starter-postgres-pguser-postgres`
...
kubectl get secret csbc-nodejs-starter-postgres-pguser-postgres -n csbc-dev

# Verify service exists
kubectl get service csbc-nodejs-starter-postgres-pgbouncer -n csbc-dev
```
...
| `image.repository` | Image repository | `bcgov/csbc-nodejs-starter/api` |
| `image.tag` | Image tag | `""` (uses appVersion) |
| `image.pullPolicy` | Image pull policy | `IfNotPresent` |
| `app.port` | Application port | `4000` |
| `app.nodeEnv` | Node environment | `production` |
| `app.database.name` | Database name | `csbc-nodejs-starter-postgres` |
| `app.database.host` | Database host | `csbc-nodejs-starter-postgres-pgbouncer` |
...
| `app.database.secretName` | Database secret name | `csbc-nodejs-starter-postgres-pguser-postgres` |
