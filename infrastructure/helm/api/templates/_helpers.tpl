...
app.kubernetes.io/part-of: {{ .Values.partOf | default "csbc-nodejs-starter" }}
...
{{- $errors = append $errors "app.database.secretName is required. This should reference the secret created by the database chart (e.g., csbc-nodejs-starter-postgres-pguser-postgres)." }}
{{- end }}
